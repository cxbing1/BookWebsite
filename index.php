...
<div class="wrap">
	<div class="header">
		<div class="logo">
			<h3><a href="index.html"><img src="images/logo.png" alt=""></a></h3>
		</div>
	...
	<div class='h_btm'>
		<div class='cssmenu'>
			<ul>
			    <li class='active'><a href='index.php'><span>主页</span></a></li>
	...
	<!------ Slider------------>
		...
		<div class="grids_1_of_3">
				<div class="grid_1_of_3 images_1_of_3">
                    ...
                    <?php
                    include("conn.php");
                    $sql="select * from book where time%2=0 limit 10";
                    $result=$db->query($sql);
				...
				<div class="grid_1_of_3 images_1_of_3">
                    ...
                    <?php
                            include("conn.php");
                            $sql="select * from book order by time desc limit 10";
                            $result=$db->query($sql);
